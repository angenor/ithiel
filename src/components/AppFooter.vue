      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 lg:gap-6">
          ...
          <div>
            ...
            <ul class="space-y-3">
              <li>
                <a href="/formations/masters" class="text-gray-400 hover:text-amber-400 transition-colors duration-300">
                  {{ t('footer.programs.masters') }}
                </a>
              </li>
              <li>
                <a href="/formations/diplomes" class="text-gray-400 hover:text-amber-400 transition-colors duration-300">
                  {{ t('footer.programs.diplomas') }}
                </a>
              </li>
              <li>
                <a href="/formations/certifications" class="text-gray-400 hover:text-amber-400 transition-colors duration-300">
                  {{ t('footer.programs.certifications') }}
                </a>
              </li>
              <li>
                <a href="/formations/doctorat" class="text-gray-400 hover:text-amber-400 transition-colors duration-300">
                  {{ t('footer.programs.doctorate') }}
                </a>
              </li>
              <li>
                <a href="/formations/fad" class="text-gray-400 hover:text-amber-400 transition-colors duration-300">
          ...
          <div>
            ...
            <ul class="space-y-3">
              <li>
                <a href="/a-propos" class="text-gray-400 hover:text-amber-400 transition-colors duration-300">
                  {{ t('footer.university.about') }}
                </a>
              </li>
              <li>
                <a href="/a-propos/mission" class="text-gray-400 hover:text-amber-400 transition-colors duration-300">
                  {{ t('footer.university.mission') }}
                </a>
              </li>
              <li>
                <a href="/a-propos/gouvernance" class="text-gray-400 hover:text-amber-400 transition-colors duration-300">
                  {{ t('footer.university.governance') }}
                </a>
              </li>
              <li>
                <a href="/a-propos/campus" class="text-gray-400 hover:text-amber-400 transition-colors duration-300">
                  {{ t('footer.university.campus') }}
                </a>
              </li>
              <li>
                <a href="/a-propos/histoire" class="text-gray-400 hover:text-amber-400 transition-colors duration-300">
          ...
          <div>
            ...
            <ul class="space-y-3">
              <li>
                <a href="/actualites" class="text-gray-400 hover:text-amber-400 transition-colors duration-300">
                  {{ t('footer.resources.news') }}
                </a>
              </li>
              <li>
                <a href="/evenements" class="text-gray-400 hover:text-amber-400 transition-colors duration-300">
                  {{ t('footer.resources.events') }}
                </a>
              </li>
              <li>
                <a href="/emplois" class="text-gray-400 hover:text-amber-400 transition-colors duration-300">
                  {{ t('footer.resources.jobs') }}
                </a>
              </li>
              <li>
                <a href="/bibliotheque" class="text-gray-400 hover:text-amber-400 transition-colors duration-300">
                  {{ t('footer.resources.library') }}
                </a>
              </li>
              <li>
                <a href="/faq" class="text-gray-400 hover:text-amber-400 transition-colors duration-300">
          ...
          <div>
            ...
            <ul class="space-y-3">
              <li>
                <a href="/reseau/alumni" class="text-gray-400 hover:text-amber-400 transition-colors duration-300">
                  {{ t('footer.network.alumni') }}
                </a>
              </li>
              <li>
                <a href="/reseau/partenaires" class="text-gray-400 hover:text-amber-400 transition-colors duration-300">
                  {{ t('footer.network.partners') }}
                </a>
              </li>
              <li>
                <a href="/reseau/campus" class="text-gray-400 hover:text-amber-400 transition-colors duration-300">
                  {{ t('footer.network.externalCampuses') }}
                </a>
              </li>
              <li>
                <a href="/contact" class="text-gray-400 hover:text-amber-400 transition-colors duration-300">
        ...
        <div class="mt-12 pt-8 border-t border-white/10">
          <div class="grid md:grid-cols-3 gap-6">
            <div class="flex items-start gap-3">
              ...
              <div>
                <h5 class="text-sm font-medium text-white mb-1">{{ t('footer.contact.title') }}</h5>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div class="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div class="flex flex-wrap items-center justify-center gap-6 text-sm">
              <a href="/mentions-legales" class="text-gray-400 hover:text-amber-400 transition-colors duration-300">
                {{ t('footer.legal.terms') }}
              </a>
              <a href="/confidentialite" class="text-gray-400 hover:text-amber-400 transition-colors duration-300">
                {{ t('footer.legal.privacy') }}
              </a>
              <a href="/cookies" class="text-gray-400 hover:text-amber-400 transition-colors duration-300">
                {{ t('footer.legal.cookies') }}
              </a>
              <a href="/accessibilite" class="text-gray-400 hover:text-amber-400 transition-colors duration-300">
