...
const orgChart = {
  president: {
    initials: 'HH',
    nameKey: 'governance.board.president.name',
    roleKey: 'governance.board.president.role',
    color: 'emerald',
    image: 'https://st.depositphotos.com/1857171/54211/i/450/depositphotos_542115218-stock-photo-positive-optimistic-bearded-man-pointing.jpg'
  },
  directors: [
    {
      id: 'secretary',
      initials: 'MK',
      nameKey: 'governance.board.secretary.name',
      roleKey: 'governance.board.secretary.role',
      color: 'cyan',
      image: 'https://st4.depositphotos.com/2208684/39327/i/450/depositphotos_393277420-stock-photo-portrait-shot-arms-crossed-handsome.jpg'
    },
    {
      id: 'treasurer',
      initials: 'AB',
      nameKey: 'governance.board.treasurer.name',
      roleKey: 'governance.board.treasurer.role',
      color: 'amber',
      image: 'https://img.freepik.com/premium-photo/portrait-young-man-sitting-his-desk-office_484651-8141.jpg'
    },
    {
      id: 'programs',
      initials: 'FN',
      nameKey: 'governance.board.programs.name',
      roleKey: 'governance.board.programs.role',
      color: 'purple',
      image: 'https://static.vecteezy.com/ti/photos-gratuite/p2/16204051-profil-de-visage-de-jeune-et-mignonne-femme-africaine-photo.jpg'
    }
  ]
}
...
const getColorClasses = (color) => {
  const colors = {
    ...
    cyan: {
      ...
      badge: 'bg-cyan-100 dark:bg-cyan-900/40 text-cyan-700 dark:text-cyan-300 border-cyan-200 dark:border-cyan-700/50'
    },
    amber: {
              ...
              <div class="org-card bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-200 dark:border-gray-700 shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-300 w-72">
                <div class="flex flex-col items-center">
                  <div class="president-avatar-ring p-1 rounded-full mb-4">
                    <img
                      v-if="orgChart.president.image"
                      :src="orgChart.president.image"
                      :alt="t(orgChart.president.nameKey)"
                      class="w-20 h-20 rounded-full object-cover"
                    />
                    <div v-else :class="[getColorClasses(orgChart.president.color).bg, 'w-20 h-20 rounded-full flex items-center justify-center']">
                ...
                <div class="org-card bg-white dark:bg-gray-800 rounded-xl p-5 border border-gray-200 dark:border-gray-700 shadow-md hover:shadow-lg hover:-translate-y-1 transition-all duration-300 w-56">
                  <div class="flex flex-col items-center">
                    <img
                      ...
                      :class="[getColorClasses(director.color).ring, 'w-16 h-16 rounded-full object-cover mb-3 ring-4']"
                    />
                    <div v-else :class="[getColorClasses(director.color).bg, getColorClasses(director.color).ring, 'w-16 h-16 rounded-full flex items-center justify-center mb-3 ring-4']">
