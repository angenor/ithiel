...
<template>
  <section
    class="relative h-screen min-h-[700px] overflow-hidden"
  >
    <!-- Background Slides -->
    ...
    <div class="relative z-10 h-full flex items-center">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div class="max-w-3xl">
          <!-- Badge -->
          <!-- <div class="inline-flex items-center space-x-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 mb-8 animate__animated animate__fadeInDown">
          ...
          <div class="flex flex-wrap gap-4 animate__animated animate__fadeInUp animate__delay-2s">
            ...
            >
              ...
              <svg class="relative z-10 w-5 h-5 ml-2 transition-transform duration-300 group-hover:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <!-- <div class="absolute bottom-0 left-0 right-0 z-20">
      <div class="bg-gradient-to-t from-black/80 to-transparent pt-20 pb-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="grid grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-16">
            <div class="text-center lg:text-left">
              <div class="text-3xl lg:text-4xl font-bold text-amber-400 mb-1">54+</div>
              <div class="text-white/70 text-sm">{{ t('hero.stats.countries') }}</div>
            </div>
            <div class="text-center lg:text-left">
              <div class="text-3xl lg:text-4xl font-bold text-amber-400 mb-1">30+</div>
              <div class="text-white/70 text-sm">{{ t('hero.stats.years') }}</div>
            </div>
            <div class="text-center lg:text-left">
              <div class="text-3xl lg:text-4xl font-bold text-amber-400 mb-1">5000+</div>
              <div class="text-white/70 text-sm">{{ t('hero.stats.graduates') }}</div>
            </div>
            <div class="text-center lg:text-left">
              <div class="text-3xl lg:text-4xl font-bold text-amber-400 mb-1">100%</div>
              <div class="text-white/70 text-sm">{{ t('hero.stats.francophone') }}</div>
            </div>
          </div>
        </div>
      </div>
